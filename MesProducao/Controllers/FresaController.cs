...
namespace MesProducao.Controllers
{
    ...
    public class FresaController : Controller
    {
        // GET api/values
        [HttpGet]
        ...
        {
            return "Iniciada operação de fresa para nova peça. ID: " + new Random().Next(6000, 9999);
        }
        ...
        {
            return "Finalizada operação de fresa para peça: ID: " + id;
        }
